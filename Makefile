...
SOURCES = main.cpp bintree.cpp dump.cpp akinator.cpp exprtree.cpp treeRW.cpp ../lib_file_proc/file.cpp ../lib_buffer_proc/buffer.cpp
OBJECTS = $(SOURCES:%.cpp=bintree_o/%.o) #rename files *.cpp --> file *.o
EXECUTABLE = bintree
#sourses is a list
